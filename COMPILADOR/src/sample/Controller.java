...
// add line numbers to the left of area
        ...
        codeArea.setPrefSize(400,600);

        Subscription cleanupWhenNoLongerNeedIt = codeArea
                .multiPlainChanges()
                .successionEnds(Duration.ofMillis(800))
    ...
    public void evtSalir(ActionEvent actionEvent) {
        System.exit(0);
    ...
    public void evtAbrir(ActionEvent actionEvent){

        FileChooser of=new FileChooser();
        of.setTitle("Abrir archivo Learn-Easy");
    ...
    public void evt(ActionEvent event) {
